 ...
 */
#define DSS_PRIV_FILENAME "/etc/storage/dropbear/dropbear_dss_host_key"
#define RSA_PRIV_FILENAME "/etc/storage/dropbear/dropbear_rsa_host_key"
#define ECDSA_PRIV_FILENAME "/etc/storage/dropbear/dropbear_ecdsa_host_key"
#define ED25519_PRIV_FILENAME "/etc/storage/dropbear/dropbear_ed25519_host_key"
